...
/**
 * Defines an individual button on a gamepad device.
 */
interface GamepadButton {
    ...
    /**
     * How far the button is pressed in the range [0.0 .. 1.0]. 0.0 must mean fully unpressed, and 1.0 must mean fully pressed.
     * @readonly
     */
    value: number;
}
